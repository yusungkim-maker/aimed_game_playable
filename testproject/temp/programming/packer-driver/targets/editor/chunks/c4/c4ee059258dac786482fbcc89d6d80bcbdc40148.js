    ...
    execute: function () {
      ...
      _export("SocketGuideArrow", SocketGuideArrow = (_dec = ccclass('SocketGuideArrow'), _dec2 = property({
        ...
        show() {
          ...
          const state = (_this$_anim = this._anim) == null ? void 0 : _this$_anim.getState(CLIP_NAME);
          if (!state) return;
        ...
        hide() {
          ...
          this._bobbing = false;
          const state = (_this$_anim2 = this._anim) == null ? void 0 : _this$_anim2.getState(CLIP_NAME);
...
//# sourceMappingURL=c4ee059258dac786482fbcc89d6d80bcbdc40148.js.map