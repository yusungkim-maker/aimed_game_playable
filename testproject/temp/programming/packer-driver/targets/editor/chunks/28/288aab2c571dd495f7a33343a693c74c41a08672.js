System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec3, Quat, NodeSpace, CoinEvents, CoinEventName, _dec, _class, _crd, ccclass, Coin;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Coin", Coin = (_dec = ccclass('Coin'), _dec(_class = class Coin extends Component {
        ...
        activate(pos, target, magnetRadius, pool, tuning, stack) {
          this._target = target;
          this._stack = stack;
          this._stackSlot = -1;
        ...
        _updatePop(dt) {
          ...
          const t = Math.min(1, this._popTimer / dur); // 스케일: 0 → 1, ease-out(초반에 빠르게 팝) — t=1에서 정확히 1.0
...
//# sourceMappingURL=288aab2c571dd495f7a33343a693c74c41a08672.js.map