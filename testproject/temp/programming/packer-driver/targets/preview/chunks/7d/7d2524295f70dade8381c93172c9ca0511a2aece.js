  ...
  return {
    ...
    execute: function () {
      ...
      _export("StructureHealthBar", StructureHealthBar = (_dec = ccclass('StructureHealthBar'), _dec2 = property({
        ...
        tooltip: '구조물마다 크기가 달라 체력바도 다르게 키우고 싶을 때 조정 (기본 1)'
      }), _dec3 = property({
        ...
        onDamaged(hp, maxHp) {
          if (!this._view) {
            ...
            this._view.node.setScale(this.barScale, this.barScale, 1);
          }
...
//# sourceMappingURL=7d2524295f70dade8381c93172c9ca0511a2aece.js.map