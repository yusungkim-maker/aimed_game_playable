System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Vec2, Vec3, UITransform, Graphics, Color, Camera, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, JoystickUI;
    ...
    execute: function () {
      ...
      _export("JoystickUI", JoystickUI = (_dec = ccclass('JoystickUI'), _dec2 = property(Node), _dec3 = property({
        ...
        _apply(e) {
          ...
          var len = Math.sqrt(local.x * local.x + local.y * local.y); // 노브는 항상 클릭/터치 지점 그대로 이동 (반경 밖이면 가장자리로 clamp)
...
//# sourceMappingURL=7ee5641c6ebff48f97bc00f47d600930d72259ee.js.map