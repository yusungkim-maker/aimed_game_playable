System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, instantiate, Coin, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _crd, ccclass, property, CoinPool;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("CoinPool", CoinPool = (_dec = ccclass('CoinPool'), _dec2 = property({
        ...
        displayName: '동시 대기 코인 최대 개수',
        tooltip: '아직 수집되지 않고(바닥에 떨어져 튀거나 대기 중인) 동시에 존재할 수 있는 코인의 전체 상한선. 넘으면 가장 오래 대기 중이던 코인부터 자석 반경과 무관하게 즉시 수집 처리되어(=플레이어/스택으로 날아가기 시작) 개수가 줄어든다 — 코인 값 자체는 잃지 않는다.'
        ...
        constructor(...args) {
          ...
          // ── 최적화 ───────────────────────────────────────────────────────────
          _initializerDefineProperty(this, "maxWaiting", _descriptor15, this);
        ...
        spawn(pos, target, magnetRadius, stack = null, fromGround = false, stayPut = false) {
          var _this$_pool$pop;

          const node = (_this$_pool$pop = this._pool.pop()) != null ? _this$_pool$pop : this._createInstance();
          node.getComponent(_crd && Coin === void 0 ? (_reportPossibleCrUseOfCoin({
            error: Error()
          }), Coin) : Coin).activate(pos, target, magnetRadius, this, this._tuning(), stack, fromGround, stayPut);
          return node;
        }
      ...
      }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "maxWaiting", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=578892ceb6f79b4d248649ccdd2ebaa8bbf92fa7.js.map