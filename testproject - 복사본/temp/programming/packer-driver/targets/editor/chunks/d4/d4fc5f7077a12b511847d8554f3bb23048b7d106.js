    ...
    execute: function () {
      ...
      _export("PlayerMoveTrigger", PlayerMoveTrigger = (_dec = ccclass('PlayerMoveTrigger'), _dec2 = property({
        ...
        _fire() {
          ...
          const spawner = (_this$monsterSpawnerN = (_this$monsterSpawnerN2 = this.monsterSpawnerNode) == null ? void 0 : _this$monsterSpawnerN2.getComponent(_crd && MonsterSpawner === void 0 ? (_reportPossibleCrUseOfMonsterSpawner({
            error: Error()
