System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, Texture2D, instantiate, Socket, SocketVariant, FollowerFormation, MonsterSpawner, TriggerId, CoinEvents, CoinEventName, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _class4, _class5, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _crd, ccclass, property, UnitSocketConfig, UnitSocketManager;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Prefab', 'Texture2D', 'instantiate']);
      ...
      _export("UnitSocketConfig", UnitSocketConfig = (_dec = ccclass('UnitSocketConfig'), _dec2 = property({
        ...
        type: Texture2D,
        displayName: '아이콘 텍스처',
        tooltip: '이 소켓 몸통 위 아이콘 판(socket_S의 "icon" 메시)에 표시할 이미지 — 소켓마다 어떤 유닛이 나오는지 다르게 보여줄 때 지정한다. 비워두면 아이콘 판 자체를 끈다(기존 씬처럼 보임). socket_L에는 아이콘 메시가 없어서 지정해도 표시되지 않는다'
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "iconTexture", _descriptor7, this);
        }
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "iconTexture", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      _export("UnitSocketManager", UnitSocketManager = (_dec9 = ccclass('UnitSocketManager'), _dec10 = property({
      ...
      }), _dec9(_class4 = (_class5 = class UnitSocketManager extends Component {
        constructor(...args) {
          super(...args);

          _initializerDefineProperty(this, "sockets", _descriptor8, this);

          _initializerDefineProperty(this, "socketPrefab", _descriptor9, this);

          _initializerDefineProperty(this, "socketPrefabS", _descriptor10, this);

          _initializerDefineProperty(this, "followerPrefab", _descriptor11, this);

          _initializerDefineProperty(this, "playerNode", _descriptor12, this);

          _initializerDefineProperty(this, "monsterSpawnerNode", _descriptor13, this);

          _initializerDefineProperty(this, "nextSocketDelay", _descriptor14, this);

          _initializerDefineProperty(this, "firstRushName", _descriptor15, this);

          _initializerDefineProperty(this, "firstRushExtraName", _descriptor16, this);

          _initializerDefineProperty(this, "unlockBuildingSocketsAfterCount", _descriptor17, this);
        ...
        _spawnCurrent() {
          ...
          const prefab = config.variant === (_crd && SocketVariant === void 0 ? (_reportPossibleCrUseOfSocketVariant({
            error: Error()
      ...
      }, (_descriptor8 = _applyDecoratedDescriptor(_class5.prototype, "sockets", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class5.prototype, "socketPrefab", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class5.prototype, "socketPrefabS", [_dec12], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor11 = _applyDecoratedDescriptor(_class5.prototype, "followerPrefab", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor12 = _applyDecoratedDescriptor(_class5.prototype, "playerNode", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor13 = _applyDecoratedDescriptor(_class5.prototype, "monsterSpawnerNode", [_dec15], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor14 = _applyDecoratedDescriptor(_class5.prototype, "nextSocketDelay", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor15 = _applyDecoratedDescriptor(_class5.prototype, "firstRushName", [_dec17], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor16 = _applyDecoratedDescriptor(_class5.prototype, "firstRushExtraName", [_dec18], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor17 = _applyDecoratedDescriptor(_class5.prototype, "unlockBuildingSocketsAfterCount", [_dec19], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=ff38111c632198f8b2b48f25ee74debe159926b7.js.map