  ...
  return {
    ...
    execute: function () {
      ...
      _export("FollowerGhostState", FollowerGhostState = (_dec = ccclass('FollowerGhostState'), _dec2 = property(Material), _dec3 = property(Material), _dec(_class = (_class2 = class FollowerGhostState extends Component {
        ...
        enterGhost() {
          const player = this.getComponent(_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
            error: Error()
          }), Player) : Player);
          ...
          for (const r of renderers) {
            ...
            const realMaterial = (_r$sharedMaterials$ = r.sharedMaterials[0]) != null ? _r$sharedMaterials$ : null;
...
//# sourceMappingURL=1c4b44b5e784a819c7d1f7353664da250ac71458.js.map