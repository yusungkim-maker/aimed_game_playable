  ...
  return {
    ...
    execute: function () {
      ...
      _export("MonsterHealthBar", MonsterHealthBar = (_dec = ccclass('MonsterHealthBar'), _dec(_class = class MonsterHealthBar extends Component {
        ...
        onDamaged(hp, maxHp) {
          if (!this._view) {
            var _instance$acquire, _instance, _mgr$bossBarScale, _mgr$barScale;
            ...
            const mgr = (_crd && MonsterHealthBarManager === void 0 ? (_reportPossibleCrUseOfMonsterHealthBarManager({
              error: Error()
            }), MonsterHealthBarManager) : MonsterHealthBarManager).instance;
            const s = this.isBoss ? (_mgr$bossBarScale = mgr == null ? void 0 : mgr.bossBarScale) != null ? _mgr$bossBarScale : 2 : (_mgr$barScale = mgr == null ? void 0 : mgr.barScale) != null ? _mgr$barScale : 1;
...
//# sourceMappingURL=f94b3c549629637e6819c34f556930d033075def.js.map