    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(Sprite), _dec3 = property(Node), _dec4 = property({
        ...
        _sweepMonsters() {
          ...
          var spawner = (_this$monsterSpawnerN3 = this.monsterSpawnerNode) == null ? void 0 : _this$monsterSpawnerN3.getComponent(_crd && MonsterSpawner === void 0 ? (_reportPossibleCrUseOfMonsterSpawner({
            error: Error()
          }), MonsterSpawner) : MonsterSpawner);
          var base = (_this$baseNode3 = this.baseNode) == null ? void 0 : _this$baseNode3.worldPosition;
          var alive = [...((_spawner$activeMonste = spawner == null ? void 0 : spawner.activeMonsters) != null ? _spawner$activeMonste : [])].filter(m => {
            var _m$node;
          ...
          var sweepTime = alive.length * this.endingKillInterval;
