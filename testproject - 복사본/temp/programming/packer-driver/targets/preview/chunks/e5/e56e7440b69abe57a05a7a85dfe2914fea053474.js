    ...
    execute: function () {
      ...
      _export("StructureHitFlash", StructureHitFlash = (_dec = ccclass('StructureHitFlash'), _dec2 = property({
        ...
        flash() {
          ...
          for (var r of this.node.getComponentsInChildren(MeshRenderer)) {
            ...
            for (var i = 0; i < r.sharedMaterials.length; i++) {
              ...
              var orig = (_r$sharedMaterials$i = r.sharedMaterials[i]) != null ? _r$sharedMaterials$i : null;
              shared.push(orig);
              ...
              var tex = orig == null ? void 0 : orig.getProperty('mainTexture');
        ...
        update(dt) {
          ...
          for (var e of this._entries) {
            ...
            for (var i = 0; i < e.shared.length; i++) {
              var orig = e.shared[i];
