      ...
      _export("StructureHealthBar", StructureHealthBar = (_dec = ccclass('StructureHealthBar'), _dec2 = property({
        ...
        onDamaged(hp, maxHp) {
          if (!this._view) {
            ...
            var mgr = (_crd && StructureHealthBarManager === void 0 ? (_reportPossibleCrUseOfStructureHealthBarManager({
              error: Error()
            }), StructureHealthBarManager) : StructureHealthBarManager).instance;
            var s = this.barScale * ((_mgr$barScale = mgr == null ? void 0 : mgr.barScale) != null ? _mgr$barScale : 1);
