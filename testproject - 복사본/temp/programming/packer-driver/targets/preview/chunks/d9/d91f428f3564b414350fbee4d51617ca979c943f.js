System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec3, Color, MeshRenderer, instantiate, tween, CoinStack, Player, FollowerMovement, FollowerGhostState, SocketPreviewSlots, SocketGuideArrow, FallingCoinVisual, AtlasNumber, SocketGauge, CoinEvents, CoinEventName, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _class3, _crd, ccclass, property, Socket;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Vec3', 'Color', 'Prefab', 'MeshRenderer', 'Texture2D', 'instantiate', 'tween']);
      ...
      _export("Socket", Socket = (_dec = ccclass('Socket'), _dec2 = property({
        ...
        displayName: '등장 확대 시간(초)',
        tooltip: '소켓이 스폰되는 순간 스케일 0→1(프리팹 원래 크기)로 커지는 데 걸리는 시간'
      }), _dec10 = property({
        displayName: '소멸 축소 시간(초)',
        tooltip: '요구치를 다 채운 소켓이 사라지기 직전 스케일 1→0으로 줄어드는 데 걸리는 시간. 반복 생산 소켓(유닛 생산용, repeatable)은 요구치를 채워도 destroy되지 않으므로 적용되지 않는다'
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "appearScaleDuration", _descriptor8, this);

          _initializerDefineProperty(this, "disappearScaleDuration", _descriptor9, this);
        ...
        onLoad() {
          var _this$_findByExactNam, _iconNode$getComponen;
          ...
          this._guideArrow = this.getComponentInChildren(_crd && SocketGuideArrow === void 0 ? (_reportPossibleCrUseOfSocketGuideArrow({
            error: Error()
          }), SocketGuideArrow) : SocketGuideArrow); // 아이콘 판은 socket_mini glb에만 있는 "icon" 노드다 — socket_large에는 없으므로 null 가능.
          ...
          var iconNode = this._findByExactName(this.node, ['icon']);

          this._iconRenderer = (_iconNode$getComponen = iconNode == null ? void 0 : iconNode.getComponent(MeshRenderer)) != null ? _iconNode$getComponen : null;
        }
        ...
        _applyIcon(tex) {
          ...
          var mr = this._iconRenderer;
          if (!mr) return; // 아이콘 판이 없는 variant(socket_large 등)

          (_mr$getMaterialInstan = mr.getMaterialInstance(0)) == null || _mr$getMaterialInstan.setProperty('mainTexture', tex);
          mr.node.active = true;
        }
        ...
        _playAppearScale() {
          var target = this.node.scale.clone();
          this.node.setScale(0, 0, 0);
          tween(this.node).to(this.appearScaleDuration, {
            scale: target
          }).start();
        }
        ...
        _spawnPreviewFollowers() {
          ...
          for (var i = 0; i < count; i++) {
            ...
            var player = node.getComponent(_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
              error: Error()
            }), Player) : Player);
        ...
        update(dt) {
          ...
          this._depositTimer = 0;
          var stack = playerNode.getComponent(_crd && CoinStack === void 0 ? (_reportPossibleCrUseOfCoinStack({
            error: Error()
          }), CoinStack) : CoinStack);
        ...
        _completeFulfillment() {
          ...
          var parent = (_this$node$scene2 = this.node.scene) != null ? _this$node$scene2 : this.node.parent; // 이 소켓이 건물 트리거로 설정돼 있으면, 같은 트리거 ID를 가진 BuildingTrigger가
          ...
          for (var node of this._previewFollowers) {
        ...
        _playDisappearScaleThenDestroy() {
          tween(this.node).to(this.disappearScaleDuration, {
        ...
        _promoteFollower(node, formation) {
          if (formation) {
            ...
            var move = (_node$getComponent2 = node.getComponent(_crd && FollowerMovement === void 0 ? (_reportPossibleCrUseOfFollowerMovement({
              error: Error()
          ...
          var ghost = node.getComponent(_crd && FollowerGhostState === void 0 ? (_reportPossibleCrUseOfFollowerGhostState({
            error: Error()
        ...
        _spawnFollowersInstant(count, playerNode, followerPrefab, spawnerNode, formation) {
          ...
          for (var i = 0; i < count; i++) {
            ...
            if (formation) {
              ...
              var move = (_node$getComponent3 = node.getComponent(_crd && FollowerMovement === void 0 ? (_reportPossibleCrUseOfFollowerMovement({
                error: Error()
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "appearScaleDuration", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "disappearScaleDuration", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=d91f428f3564b414350fbee4d51617ca979c943f.js.map