      ...
      _export("MonsterHealthBar", MonsterHealthBar = (_dec = ccclass('MonsterHealthBar'), _dec(_class = class MonsterHealthBar extends Component {
        ...
        onDamaged(hp, maxHp) {
          if (!this._view) {
            ...
            var mgr = (_crd && MonsterHealthBarManager === void 0 ? (_reportPossibleCrUseOfMonsterHealthBarManager({
              error: Error()
            }), MonsterHealthBarManager) : MonsterHealthBarManager).instance;
            var s = this.isBoss ? (_mgr$bossBarScale = mgr == null ? void 0 : mgr.bossBarScale) != null ? _mgr$bossBarScale : 2 : (_mgr$barScale = mgr == null ? void 0 : mgr.barScale) != null ? _mgr$barScale : 1;
