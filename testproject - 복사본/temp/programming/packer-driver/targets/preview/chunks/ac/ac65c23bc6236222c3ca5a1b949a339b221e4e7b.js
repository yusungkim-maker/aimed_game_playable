    ...
    execute: function () {
      ...
      _export("VirtualWall", VirtualWall = (_dec = ccclass('VirtualWall'), _dec2 = property({
        ...
        activate() {
          ...
          var s = this.node.worldScale; // yaw는 **그대로** 쓴다 — 부호를 뒤집으면 안 된다. blocks()가 계산하는
          ...
          var yaw = this._yaw(this.node.worldRotation);
