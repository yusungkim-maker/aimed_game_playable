    ...
    execute: function () {
      ...
      _export("MonsterSpawner", MonsterSpawner = (_dec23 = ccclass('MonsterSpawner'), _dec24 = property({
        ...
        _spawnMonster(g, rush) {
          ...
          var allWaypoints = g.path.waypoints;
          ...
          var startAnchorIdx = Math.max(g.startWaypointIndex, 0) * g.path.samplesPerSegment;
          var startIdx = Math.min(startAnchorIdx, allWaypoints.length - 1);
          ...
          if (this.monsterCastShadow) {
            for (var r of monster.getComponentsInChildren(MeshRenderer)) {
